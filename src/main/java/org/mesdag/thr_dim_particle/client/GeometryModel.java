...
public class GeometryModel {
    ...
    private static void l(CompiledVertex vertex, long ptr, float x, float y, float z, int c, int l) {
        ...
        MemoryUtil.memPutLong(ptr + ParticleBuffer.MODEL_LIGHT, vertex.l | (l & 0xF000F0));
        MemoryUtil.memPutInt(ptr + ParticleBuffer.U, vertex.u);
        MemoryUtil.memPutInt(ptr + ParticleBuffer.V, vertex.v);
    }
