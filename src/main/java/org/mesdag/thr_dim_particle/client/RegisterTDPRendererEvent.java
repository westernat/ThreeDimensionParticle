...
public class RegisterTDPRendererEvent extends Event implements IModBusEvent {
    ...
    private static final Map<ModelType, ImmutableTriple<Function<EntityRendererProvider.Context, HardcodeModel.Renderer<?>>, @Nullable ModelLayerLocation, @Nullable Supplier<LayerDefinition>>> hardcodeCache = new HashMap<>();
    private static final Map<ModelType, MutableTriple<@Nullable Function<EntityRendererProvider.Context, GeometryModel.Renderer<?>>, @Nullable ResourceLocation, @Nullable ModelResourceLocation>> geometryCache = new HashMap<>();
    private static final Map<ModelType, Function<EntityRendererProvider.Context, ModelRenderer<?>>> customCache = new HashMap<>();
    private static Map<ModelType, ModelRenderer<?>> map = ImmutableMap.of();
